...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="content-wrapper">
                        <div class="row">
                            ...
                            <div class="col-lg-6 grid-margin stretch-card">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="mb-4">
                                            17% increase in sales than last week
                                        </p>
                                        <canvas
                                            id="barChart"
                                            style="height: 250px"
                            ...
                            <div class="col-lg-6 grid-margin stretch-card">
                                <div class="card">
                                    <div
                                        class="p-4 pr-5 border-bottom bg-light d-flex justify-content-between"
                                    >
                                        <h4 class="card-title mb-0">
                                            Radar chart
                                        </h4>
                                    ...
                                    <div class="card-body">
                                        ...
                                        ></canvas>
                                        <div
                                            class="d-flex mt-5 py-3 border-top"
                                        >
                                            <p
                                            ...
                                            <p
                                                class="mb-0 ml-auto text-primary"
                                            >
                                                56%
                                            </p>
                                        </div>
        ...
        <script src="../../dashboard/assets/js/shared/chart.js"></script>
