...
<html lang="en">
    <head>
        ...
        <link
            rel="stylesheet"
            href="../../dashboard/assets/vendors/iconfonts/mdi/css/materialdesignicons.min.css"
        />
        <link
            rel="stylesheet"
            href="../../dashboard/assets/vendors/iconfonts/ionicons/dist/css/ionicons.css"
        />
        <link
            rel="stylesheet"
            href="../../dashboard/assets/vendors/iconfonts/flag-icon-css/css/flag-icon.min.css"
        />
        <link
            rel="stylesheet"
            href="../../dashboard/assets/vendors/css/vendor.bundle.base.css"
        />
        <link
            rel="stylesheet"
            href="../../dashboard/assets/vendors/css/vendor.bundle.addons.css"
        />
        <!-- endinject -->
        <!-- inject:css -->
        <link
            rel="stylesheet"
            href="../../dashboard/assets/css/shared/style.css"
        />
        <!-- endinject -->
        <!-- Layout styles -->
        <link
            rel="stylesheet"
            href="../../dashboard/assets/css/demo_1/style.css"
        />
        <!-- End Layout styles -->
        <link
            rel="shortcut icon"
    ...
    <body>
            ...
            >
                ...
                >
                    <a class="navbar-brand brand-logo" href="../../index.html">
                        <img
                            src="../../dashboard/assets/images/logo.svg"
                            alt="logo"
                        />
                    </a>
                    <a
                    ...
                    >
                        <img
                            src="../../dashboard/assets/images/logo-mini.svg"
                            alt="logo"
                        />
                    </a>
                </div>
                <div class="navbar-menu-wrapper d-flex align-items-center">
                    <ul class="navbar-nav">
                        <li
                            class="nav-item font-weight-semibold d-none d-lg-block"
                        >
                            Help : +050 2992 709
                        </li>
                        <li class="nav-item dropdown language-dropdown">
                            ...
                            >
                                ...
                                <span
                                    class="profile-text font-weight-medium d-none d-md-block"
                                    >English</span
                                >
                            </a>
                            <div
                    ...
                    <form
                        class="ml-auto search-form d-none d-md-block"
                        action="#"
                    >
                        ...
                        <li class="nav-item dropdown">
                            ...
                            >
                                <a class="dropdown-item py-3">
                                    <p
                                        class="mb-0 font-weight-medium float-left"
                                    >
                                ...
                                <a class="dropdown-item preview-item">
                                    <div class="preview-thumbnail">
                                        <img
                                            src="../../dashboard/assets/images/faces/face10.jpg"
                                            alt="image"
                                ...
                                <a class="dropdown-item preview-item">
                                    <div class="preview-thumbnail">
                                        <img
                                            src="../../dashboard/assets/images/faces/face12.jpg"
                                            alt="image"
                                            class="img-sm profile-pic"
                                        />
                                    </div>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            >
                                ...
                                <a class="dropdown-item preview-item py-3">
                                    <div class="preview-thumbnail">
                                        <i
                                            class="mdi mdi-alert m-auto text-primary"
                                        ></i>
                                    </div>
                                    <div class="preview-item-content">
                                        ...
                                        <p
                                            class="font-weight-light small-text mb-0"
                                        >
                                            Just now
                                        </p>
                                    </div>
                                ...
                                <a class="dropdown-item preview-item py-3">
                                    <div class="preview-thumbnail">
                                        <i
                                            class="mdi mdi-settings m-auto text-primary"
                                        ></i>
                                    </div>
                                    <div class="preview-item-content">
                                        <h6
                                ...
                                <a class="dropdown-item preview-item py-3">
                                    <div class="preview-thumbnail">
                                        <i
                                            class="mdi mdi-airballoon m-auto text-primary"
                                        ></i>
                                    </div>
                                    <div class="preview-item-content">
                                        <h6
                        ...
                        >
                            ...
                            >
                                <img
                                    ...
                                    src="../../dashboard/assets/images/faces/face8.jpg"
                                    alt="Profile image"
                                />
                            </a>
                            <div
                            ...
                            >
                                ...
                                <a class="dropdown-item"
                                    >Messages<i
                                        class="dropdown-item-icon ti-comment-alt"
                                    ></i
                                ></a>
                                <a class="dropdown-item"
                                    >Activity<i
                                        class="dropdown-item-icon ti-location-arrow"
                                    ></i
                                ></a>
                                <a class="dropdown-item"
                                    >FAQ<i
                                        class="dropdown-item-icon ti-help-alt"
                                    ></i
                                ></a>
                                <a class="dropdown-item"
                                    >Sign Out<i
                ...
                <nav class="sidebar sidebar-offcanvas" id="sidebar">
                    <ul class="nav">
                        ...
                        <li class="nav-item">
                            ...
                            >
                                <i
                                    class="menu-icon typcn typcn-shopping-bag"
                                ></i>
                        ...
                        <li class="nav-item">
                            ...
                            >
                                <i
                                    class="menu-icon typcn typcn-document-add"
                                ></i>
                                        ...
                                        <div class="col-md-6">
                                            <div class="card-body">
                                                ...
                                                <div class="template-demo">
                                                    ...
                                                    <button
                                                        type="button"
                                                        class="btn btn-icons btn-rounded btn-secondary"
                                                    >
                                                        <i
                                                            class="mdi mdi-edge"
                                                        ></i>
                                                    ...
                                                    <button
                                                        type="button"
                                                        class="btn btn-icons btn-inverse-warning"
                                                    >
                                                        <i
                                                            class="mdi mdi-map-marker"
                                                        ></i>
                                        ...
                                        <div class="col-md-6">
                                            <div class="card-body">
                                                ...
                                                <div class="template-demo">
                                                    <button
                                                        type="button"
                                                        class="btn btn-icons btn-rounded btn-outline-light"
                                                    >
                                                        <i
                                                            class="mdi mdi-home-outline"
                                                        ></i>
                                                    ...
                                                    <button
                                                        type="button"
                                                        class="btn btn-icons btn-rounded btn-outline-warning"
                                                    >
                                                        <i
                                                            class="mdi mdi-map-marker"
                                                        ></i>
                                                    ...
                                                    <button
                                                        type="button"
                                                        class="btn btn-icons btn-rounded btn-outline-info"
                                                    >
                                                        <i
                                                            class="mdi mdi-code-braces"
                                                        ></i>
                                                    ...
                                                    <button
                                                        type="button"
                                                        class="btn btn-icons btn-rounded btn-inverse-outline-light"
                                                    >
                                                        <i
                                                            class="mdi mdi-home-outline"
                                                        ></i>
                                                    ...
                                                    <button
                                                        type="button"
                                                        class="btn btn-icons btn-rounded btn-inverse-outline-secondary"
                                                    >
                                                        <i
                                                            class="mdi mdi-edge"
                                                        ></i>
                                                    ...
                                                    <button
                                                        type="button"
                                                        class="btn btn-icons btn-rounded btn-inverse-outline-success"
                                                    >
                                                        <i
                                                            class="mdi mdi-email"
                                                        ></i>
                                                    ...
                                                    <button
                                                        type="button"
                                                        class="btn btn-icons btn-rounded btn-inverse-outline-primary"
                                                    >
                                                        <i
                                                            class="mdi mdi-star"
                                                        ></i>
                                                    ...
                                                    <button
                                                        type="button"
                                                        class="btn btn-icons btn-rounded btn-inverse-outline-warning"
                                                    >
                                                        <i
                                                            class="mdi mdi-map-marker"
                                                        ></i>
                                                    ...
                                                    <button
                                                        type="button"
                                                        class="btn btn-icons btn-rounded btn-inverse-outline-info"
                                                    >
                                                        <i
                                                            class="mdi mdi-code-braces"
                                                        ></i>
                                        ...
                                        <div class="col-md-6">
                                            <div class="card-body">
                                                ...
                                                <div class="template-demo">
                                                    ...
                                                    <button
                                                        type="button"
                                                        class="btn btn-inverse-light btn-fw"
                                                    >
                                                        Light
                                                    </button>
                                                    <button
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="template-demo">
                                                    ...
                                                    <button
                                                        type="button"
                                                        class="btn btn-inverse-secondary btn-rounded btn-fw"
                                                    >
                                                        Secondary
                                                    </button>
                                                    <button
                                                    ...
                                                    <button
                                                        type="button"
                                                        class="btn btn-inverse-info btn-rounded btn-fw"
                                                    >
                                                        Info
                                                    </button>
                                                    <button
                                                        type="button"
                                                        class="btn btn-inverse-light btn-rounded btn-fw"
                                                    >
                                                        Light
                                                    </button>
                                                    <button
                                                        type="button"
                                                        class="btn btn-inverse-dark btn-rounded btn-fw"
                                                    >
                                                        Dark
                                                    </button>
                                                    <button
                                                        type="button"
                                                        class="btn btn-inverse-link btn-rounded btn-fw"
                                                    >
                                                        Link
                                                    </button>
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="card-body">
                                                ...
                                                <div class="template-demo">
                                                    ...
                                                    <button
                                                        type="button"
                                                        class="btn btn-outline-secondary btn-rounded btn-fw"
                                                    >
                                                        Secondary
                                                    </button>
                                                    <button
                                                        type="button"
                                                        class="btn btn-outline-success btn-rounded btn-fw"
                                                    >
                                                        Success
                                                    </button>
                                                    <button
                                                        type="button"
                                                        class="btn btn-outline-danger btn-rounded btn-fw"
                                                    >
                                                        Danger
                                                    </button>
                                                    <button
                                                        type="button"
                                                        class="btn btn-outline-warning btn-rounded btn-fw"
                                                    >
                                                        Warning
                                                    </button>
                                                    <button
                                                    ...
                                                    <button
                                                        type="button"
                                                        class="btn btn-outline-light btn-rounded btn-fw"
                                                    >
                                                        Light
                                                    </button>
                                                    <button
                                                    ...
                                                    <button
                                                        type="button"
                                                        class="btn btn-outline-link btn-rounded btn-fw"
                                                    >
                                                        Link
                                                    </button>
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="card-body">
                                                ...
                                                <p class="card-description">
                                                    use class
                                                    <code>.social-btn</code> for
                                                    social button
                                                </p>
                                                <div class="template-demo">
                                                    <button
                                                        type="button"
                                                        class="btn social-btn btn-facebook"
                                                    >
                                                        <i
                                                    ...
                                                    <button
                                                        type="button"
                                                        class="btn social-btn btn-twitter"
                                                    >
                                                        <i
                                                    ...
                                                    <button
                                                        type="button"
                                                        class="btn social-btn btn-dribbble"
                                                    >
                                                        <i
                                                    ...
                                                    <button
                                                        type="button"
                                                        class="btn social-btn btn-linkedin"
                                                    >
                                                        <i
                                                    ...
                                                    <button
                                                        type="button"
                                                        class="btn social-btn btn-google"
                                                    >
                                                        <i
                                                    ...
                                                    <button
                                                        type="button"
                                                        class="btn social-btn btn-social-outline-facebook"
                                                    >
                                                        <i
                                                            class="mdi mdi-facebook"
                                                        ></i>
                                                    ...
                                                    <button
                                                        type="button"
                                                        class="btn social-btn btn-social-outline-twitter"
                                                    >
                                                        <i
                                                            class="mdi mdi-twitter"
                                                        ></i>
                                                    ...
                                                    <button
                                                        type="button"
                                                        class="btn social-btn btn-social-outline-dribbble"
                                                    >
                                                        <i
                                                            class="mdi mdi-dribbble"
                                                        ></i>
                                                    ...
                                                    <button
                                                        type="button"
                                                        class="btn social-btn btn-social-outline-linkedin"
                                                    >
                                                        <i
                                                            class="mdi mdi-linkedin"
                                                        ></i>
                                                    ...
                                                    <button
                                                        type="button"
                                                        class="btn social-btn btn-social-outline-google"
                                                    >
                                                        <i
                                                            class="mdi mdi-google-plus"
                                                        ></i>
                                        ...
                                        <div class="col-6">
                                            <div class="card-body">
                                                ...
                                                <div class="template-demo">
                                                    <button
                                                        type="button"
                                                        class="btn social-btn btn-rounded btn-facebook"
                                                    >
                                                        <i
                                                            class="mdi mdi-facebook"
                                                        ></i>
                                                    ...
                                                    <button
                                                        type="button"
                                                        class="btn social-btn btn-rounded btn-twitter"
                                                    >
                                                        <i
                                                            class="mdi mdi-twitter"
                                                        ></i>
                                                    ...
                                                    <button
                                                        type="button"
                                                        class="btn social-btn btn-rounded btn-dribbble"
                                                    >
                                                        <i
                                                            class="mdi mdi-dribbble"
                                                        ></i>
                                                    ...
                                                    <button
                                                        type="button"
                                                        class="btn social-btn btn-rounded btn-linkedin"
                                                    >
                                                        <i
                                                            class="mdi mdi-linkedin"
                                                        ></i>
                                                    ...
                                                    <button
                                                        type="button"
                                                        class="btn social-btn btn-rounded btn-google"
                                                    >
                                                        <i
                                                            class="mdi mdi-google-plus"
                                                        ></i>
                                                    ...
                                                    <button
                                                        type="button"
                                                        class="btn social-btn btn-rounded btn-social-outline-facebook"
                                                    >
                                                        <i
                                                            class="mdi mdi-facebook"
                                                        ></i>
                                                    ...
                                                    <button
                                                        type="button"
                                                        class="btn social-btn btn-rounded btn-social-outline-dribbble"
                                                    >
                                                        <i
                                                            class="mdi mdi-dribbble"
                                                        ></i>
                                                    ...
                                                    <button
                                                        type="button"
                                                        class="btn social-btn btn-rounded btn-social-outline-linkedin"
                                                    >
                                                        <i
                                                            class="mdi mdi-linkedin"
                                                        ></i>
                                                    ...
                                                    <button
                                                        type="button"
                                                        class="btn social-btn btn-rounded btn-social-outline-google"
                                                    >
                                                        <i
                                                            class="mdi mdi-google-plus"
                                                        ></i>
        ...
        <!-- endinject -->
        <script
            src="../../dashboard/assets/js/shared/jquery.cookie.js"
