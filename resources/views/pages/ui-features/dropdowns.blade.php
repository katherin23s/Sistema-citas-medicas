                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-description">
                                            ...
                                            button or link) and the dropdown
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-description">
                                            Add class
                                            <code>.btn-outline-{color}</code> to
                                            the button inside
                                            <code>.dropdown</code>
                                        </p>
                                        <div class="template-demo">
                                        ...
                                        <div class="template-demo">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="dropdown">
                                                        <button
                                                            class="btn btn-warning icon-btn dropdown-toggle"
                                                            type="button"
                                                    ...
                                                    <div class="dropdown">
                                                        <button
                                                            class="btn btn-danger dropdown-toggle icon-btn"
                                                            type="button"
                                                    ...
                                                    <div class="dropdown">
                                                        <button
                                                            type="button"
                                                            class="btn btn-light icon-btn dropdown-toggle dropdown-toggle-split"
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="dropdown">
                                                        <button
                                                            type="button"
                                                            class="btn btn-success icon-btn dropdown-toggle"
                                                    ...
                                                    <div class="dropdown">
                                                        <button
                                                            type="button"
                                                            class="btn btn-secondary icon-btn dropdown-toggle"
                                                    ...
                                                    <div class="dropdown">
                                                        <button
                                                            class="btn btn-primary icon-btn dropdown-toggle"
                                                            type="button"
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="dropdown">
                                                        <button
                                                            type="button"
                                                            class="btn btn-info icon-btn dropdown-toggle"
                            ...
                            <div class="col-lg-6 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-description">
                                            Add class
                                            <code>.btn-{size}</code> to dropdown
                                            buttons
                                        </p>
