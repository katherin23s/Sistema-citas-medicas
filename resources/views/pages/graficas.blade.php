                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex mt-5 py-3 border-top">
                                        <p class="mb-0 font-weight-semibold"><span
                                                class="dot-indicator bg-success"></span> Student A </p>
                                        <p class="mb-0 ml-auto text-primary">56%</p>
                                    </div>
                                    <div class="d-flex pt-3 border-top">
                                        <p class="mb-0 font-weight-semibold"><span
                                                class="dot-indicator bg-success"></span> Student B</p>
                        ...
                        <div class="col-lg-6 grid-margin stretch-card">
                            <div class="card">
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="d-flex mt-5 py-3 border-top">
                                        <p class="mb-0 font-weight-semibold"><span
                                                class="dot-indicator bg-success"></span> Product Sales </p>
                                        <p class="mb-0 ml-auto text-primary">$2,464</p>
                                    </div>
                                    <div class="d-flex pt-3 border-top">
                                        <p class="mb-0 font-weight-semibold"><span
                                                class="dot-indicator bg-success"></span>Profit Attained </p>
