    ...
    <div class="main-panel">
                        ...
                        <div class="form-group">
                            <div class="row m-l-0 m-0 pr-4">
                                ...
                                <div class="col-12 col-sm-6 col-xl">
                                    <div class="form-group row ml-2">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control" id="idFechaCita" name="fechaCita" type="date"
                                                value="{{ old('fechaCita') }}" require>
                                        </div>
                                    </div>
                                </div>
                                <!-- Hora inicial -->
                                <div class="col-12 col-sm-6 col-xl">
                                    <div class="form-group row ">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control" id="idHoracita" name="horaCita" type="time"
                                                value="{{ old('horaCita') }}" require>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12 col-sm-6 col-xl">
                                    <div class="form-group row ">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control" type="time" id="idHorafincita" name="horaFinCita"
                                                value="{{ old('horaFinCita') }}" require>
                                        </div>
                                    </div>
                                </div>
                                <!-- Tiempo de duracion -->
                            ...
                            <div class="form-group ml-5 mr-5">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col input-group mb-3">
                                        <input class="form-control" id="idPacienteCita" name="paciente"
                                            placeholder="paciente" value="{{ old('paciente') }}" disabled require>
                                        <div class="input-group-append">
                                            <button class="btn btn-primary" type="button" data-toggle="modal"
                                                data-target="#modalPacientes">Button</button>
                                        </div>
                                    </div>
                                </div>

                                <input type="hidden" class="form-control" id="id_paciente" name="paciente"
                                    placeholder="paciente" value="{{ old('paciente') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col input-group mb-3">
                                        ...
                                        <div class="input-group-append">
                                            <button class="btn btn-primary" type="button" data-toggle="modal"
                                                data-target="#modalMedicoCitas">Button</button>
                                        </div>
                                    </div>
                                </div>

                                <input type="hidden" class="form-control" id="id_medico" name="medico" placeholder="medico"
                                    value="{{ old('medico') }}">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <form action="{{ route('citas.index') }}" method="GET">
                                    <div class="row m-0 d-flex">
                                        ...
                                        <button type="button" class="btn btn-primary col-12 col-xl-1 my-5 mr-auto "
                                            onclick="window.location='{{ route('citas.index') }}'">Mostrar todo </button>
                                        <!-- -->

                                        <!-- -->
                                        <div class="form-group col-2 mt-4 p-0 mr-4">
                                            <label for="exampleFormControlSelect1">Fecha inicio</label>
                                            <input class="form-control" id="idFechaCita" name="fechaCitaInicio" type="date"
                                                value="2013-01-08" require>

                                        </div>
                                        <!-- -->
                                        <div class="form-group col-2 mt-4 p-0 mr-4">
                                            <label for="exampleFormControlSelect1">Fecha final</label>
                                            <input class="form-control" id="idFechaCita2" name="fechaCitaFinal" type="date"
                                                value="2022-01-08" require>
                                        </div>

                                        <!-- -->
                                        <div class="form-group col-2 mt-4 p-0 mr-4">
                                            <label for="exampleFormControlSelect1">Estado</label>
                                            <select class="form-control form-control-lg" id="idEstado" name="selecEstado"
                            ...
                            <div class="row d-flex justify-content-end p-1">
                                <div class=" mr-2" role="group" aria-label="First group">
                                    ...
                                    <button id="btn-pagar" data-toggle="modal" data-target="#pagar-cita" type="button"
        ...
        <script>
            ...
            $("#btn-save").click(function(e) {
                ...
                if (folioinput === "" || fechaCita === "" || Horacita === "" || horaFinCita === "" || duracion ===
                    "" || tipoCita === "" || paciente === "" || NombreMedico === "" || titulo === "" ||
                    descripcion === "") {
            ...
            $("#idTabla tbody tr").click(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $("#idPacienteCita").val(data.paciente.nombre + " " + data.paciente.apellido +
                            " " + data.paciente.apellidoM);
                        $("#NombreMedico").val(data.medico.nombre + " " + data.medico.apellido + " " +
                            data.medico.apellidoM);
                    },
