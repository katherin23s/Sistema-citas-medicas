                        ...
                        <div class="card">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="row m-0 d-flex">
                                    ...
                                    <button type="button" id="añadir" class="btn btn-primary col-12 col-xl-1 my-5 mr-auto"
                                        id="agregar" data-toggle="modal" data-target="#altaModal">Añadir
                                        seleccionado</button>

                                    <button type="button" class="btn btn-primary my-5 p-3" id="agregar" data-toggle="modal"
                                        data-target="#altaModal">Altas</button>
                                    <!-- -->
