                            ...
                            <div id="idTabla" class="table-responsive">
                                <table class="table table-striped table-hover" id="tblMain">
                                    ...
                                    <tbody id="medicos-list" name="medicos-list">
                                        <tr id="medicos{{$facturacion->idFacturacion}}" action="{{ $facturacion->idFacturacion}}">
                                            ...
                                            <td>
                                                <button id="{{ $facturacion->idFacturacion}}" data-id="{{ $facturacion->idFacturacion}}" onclick="goDoSomething(this);" type="button" class="btn btn-success">
