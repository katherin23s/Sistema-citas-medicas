                                ...
                                <div id="idTabla" class="table-responsive">
                                    <table class="table table-striped table-hover" id="tblMain">
                                        <thead class="bg-primary">
                                            <tr>
                                                <th>idEspecializacion</th>
                                                <th>Nombre Especializacion</th>
                                                <th>descripcion</th>
                                                <th>Activo</th>
                                                <th>Acciones</th>
                                            </tr>
                                        ...
                                        @foreach ($especializaciones as $especializacion)
                                            <tbody id="medicos-list" name="medicos-list">
                                                <tr id="medicos{{ $especializacion->idMedico }}"
                                                    action="{{ $especializacion->idMedicos }}">
                                                    <td>{{ $especializacion->idEspecializacion }}</td>
                                                    <td id=" idCita" type="hidden" style="display:none;">
                                                        {{ $especializacion->idEspecializacion }}</td>
                                                    <td>{{ $especializacion->nombreEspecializacion }}</td>
                                                    <td>{{ $especializacion->descripcion }}</td>
                                                    <td>{{ $especializacion->activo }}</td>

                                                    <td>
                                                        <button id="{{ $especializacion->idEspecializacion }}"
                                                            data-id="{{ $especializacion->idEspecializacion }}"
                                                            type="button" class="btn btn-success" data-toggle="modal"
                                                            data-target="#modal-update-especializacion-{{ $especializacion->idEspecializacion }}"
                                                            action="{{ $especializacion->idEspecializacion }}">
                                                        ...
                                                        <button type="button" class="btn btn-danger" data-toggle="modal"
                                                            data-target="#modal-delete-especializacion-{{ $especializacion->idEspecializacion }}">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
