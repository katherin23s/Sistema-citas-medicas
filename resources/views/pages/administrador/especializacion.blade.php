                            ...
                            <div id="idTabla" class="table-responsive">
                                <table class="table table-striped table-hover" id="tblMain">
                                    ...
                                    <tbody id="medicos-list" name="medicos-list">
                                        <tr id="medicos{{$especializacion->idMedico}}" action="{{ $especializacion->idMedicos}}">
                                            ...
                                            <td>
                                                <button id="{{ $especializacion->idEspecializacion}}" data-id="{{ $especializacion->idEspecializacion}}" type="button" class="btn btn-success" data-toggle="modal" data-target="#modal-update-especializacion-{{$especializacion->idEspecializacion}}" action="{{ $especializacion->idEspecializacion}}">
